    ...
    <form method="POST" action="/rules">
        ...
        <div class="form-group" style="border-top:1px solid var(--border);padding-top:12px">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:12px">
                <div>
                    <input type="number" name="buy_below_pct" value="{{ old('buy_below_pct') }}" step="0.01" placeholder="% below avg">
                    <span style="color:var(--muted);font-size:12px">% under the average paid</span>
                </div>
                <div>
                    <input type="number" name="buy_amount" value="{{ old('buy_amount') }}" step="0.01" placeholder="cash each time">
                    <span style="color:var(--muted);font-size:12px">Amount to spend per trigger</span>
                </div>
                <div>
                    <input type="number" name="max_position_value" value="{{ old('max_position_value') }}" step="0.01" placeholder="never exceed">
