...
<div class="card" style="max-width:480px">
    <form method="POST" action="/rules/{{ $rule->id }}">
        ...
        <div class="form-group">
            ...
            <select name="action">
                <option value="order" @selected(old('action', $rule->action) === 'order')>Place a sell order</option>
                <option value="notify" @selected(old('action', $rule->action) === 'notify')>Only notify me</option>
            </select>
